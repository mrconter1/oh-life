  ...
  return (
    <div className="h-screen w-full overflow-hidden relative bg-gradient-to-b from-background to-muted">
      ...
      <div className="absolute top-6 right-6 z-10 flex gap-2 items-center">
        <Button 
          variant="default" 
          className="h-10 px-5 shadow-md cursor-pointer hover:cursor-pointer flex items-center" 
        ...
        <Button 
          variant="outline" 
          className="w-10 h-10 p-0 rounded-full shadow-md cursor-pointer hover:cursor-pointer flex items-center justify-center" 
